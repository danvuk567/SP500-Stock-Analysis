...
In this project, I designed and implemented an end-to-end ETL process from scratch along with analytics and visualizations. 
The focus was transform, load and study S&P 500 stock return data. The sections below describe, in great detail, the 
