...
The python package requirments are listed in the requirements.txt file: 

### *[requirements.txt](https://github.com/danvuk567/SP500-Stock-Analysis/blob/main/Python-ETL-Process/requirements.txt)*  
