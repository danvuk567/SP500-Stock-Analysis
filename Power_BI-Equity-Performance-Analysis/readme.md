...
The following sections describe the detailed steps involved to create the dashboards for this project within the Power BI file called *Equity-Performance-Analysis.pbix*.
